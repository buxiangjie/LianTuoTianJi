...
logger = Logger(logger="test_jfqjyv2_9_periods_tp").getlog()
...
class JfqjyV29Tp(unittest.TestCase):
	...
	def test_113_offline_repay_repayment(self):
		...
		param = json.loads(data[0]['param'])
		period = 1
		plan_pay_date = GetSqlData.get_repayment_plan_date(project_id=self.r.get("jfqjyv2_9_periods_projectId"),
