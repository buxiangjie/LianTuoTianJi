...
@describe:任买医美主动还款结果查询接口字段必填项校验
"""
import unittest
import os
import json
...
class DeductionQuery(unittest.TestCase):
    ...
    @ddt.data(*excel_data)
    def test_deduction_query(self, data):
